...
<div class="md:flex md:items-center">
      <div class="md:w-1/2 px-10">
        <form action="{{ route('imagenes.store')}}" method="POST" enctype="multipart/form-data" id="dropzone" class=" bg-gray-300 dropzone border-dashed
      ...
      <div class="mb-5">
        <label for="description" class="mb-2   block uppercase text-gray-400 font-bold">
         Descripcion
          ...
          class="border p-3 w-full rounded-lg">{{old('description')}}</textarea>
          @error('description')
        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">
       {{ $message }}
        </p>
